#ifndef HALIDE__histogram_h
#define HALIDE__histogram_h
#include <stdint.h>
...
int histogram(struct halide_buffer_t *_p1_buffer, int32_t _p0, struct halide_buffer_t *_histogram_buffer);

HALIDE_FUNCTION_ATTRS
int histogram_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *histogram_metadata();
