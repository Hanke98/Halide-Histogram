#ifndef HALIDE__include___threshold_binary_h
#define HALIDE__include___threshold_binary_h
#include <stdint.h>
...
int threshold_binary_par_for_threshold_binary_s0_y_rebased(void *__user_context, int32_t _threshold_binary_s0_y_rebased, uint8_t *_closure_arg);
HALIDE_FUNCTION_ATTRS
int threshold_binary(struct halide_buffer_t *_input_buffer, int32_t _threshold, struct halide_buffer_t *_threshold_binary_buffer);

HALIDE_FUNCTION_ATTRS
int threshold_binary_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *threshold_binary_metadata();
