#ifndef HALIDE__include___threshold_to_zero_h
#define HALIDE__include___threshold_to_zero_h
#include <stdint.h>
...
int threshold_to_zero_par_for_threshold_to_zero_s0_y_rebased(void *__user_context, int32_t _threshold_to_zero_s0_y_rebased, uint8_t *_closure_arg__2);
HALIDE_FUNCTION_ATTRS
int threshold_to_zero(struct halide_buffer_t *_input_buffer, int32_t _threshold, struct halide_buffer_t *_threshold_to_zero_buffer);

HALIDE_FUNCTION_ATTRS
int threshold_to_zero_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *threshold_to_zero_metadata();
