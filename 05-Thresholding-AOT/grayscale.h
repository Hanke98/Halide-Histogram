#ifndef HALIDE__grayscale_h
#define HALIDE__grayscale_h
#include <stdint.h>
...
int grayscale_par_for_grayscale_s0_y_rebased(void *__user_context, int32_t _grayscale_s0_y_rebased, uint8_t *_closure_arg);
HALIDE_FUNCTION_ATTRS
int grayscale(struct halide_buffer_t *_p1_buffer, int32_t _p0, struct halide_buffer_t *_grayscale_buffer);
